...
const notificationPreferencesSchema = new mongoose.Schema(
  {
    ...
    email: {
      ...
      types: {
        ...
        new_logistics_registered: { type: Boolean, default: true },
        verification_requested: { type: Boolean, default: true },
        dispute_created: { type: Boolean, default: true },
        dispute_escalated: { type: Boolean, default: true },
        payment_issue: { type: Boolean, default: true },
        high_volume_activity: { type: Boolean, default: true },
        suspicious_activity: { type: Boolean, default: true },
        feature_update: { type: Boolean, default: true },
        policy_update: { type: Boolean, default: true },
      },
      frequency: {
        type: String,
...
// Static methods
notificationPreferencesSchema.statics.getUserPreferences = async function (
  userId
) {
...
notificationPreferencesSchema.statics.updateUserPreferences = async function (
  userId,
  updates
) {
