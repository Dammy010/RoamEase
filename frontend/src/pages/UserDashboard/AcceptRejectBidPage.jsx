...
const AcceptRejectBidPage = () => {
  ...
  const [showPriceNegotiationModal, setShowPriceNegotiationModal] =
    useState(false);
  ...
  const isOwner =
    ...
    currentShipment.user._id === user._id;
  ...
  useEffect(() => {
    if (
      ...
      (!selectedBid || !filteredBids.some((b) => b._id === selectedBid._id))
    ) {
      const initialSelectedBid =
        filteredBids.find((bid) => bid.status === "pending") ||
  ...
  const handleRequestPriceUpdate = async () => {
    ...
    try {
      const response = await api.post(
        `/bids/${selectedBid._id}/request-price-update`,
        {
      ...
      toast.success(
        `Price update request sent to ${
          selectedBid.logisticsCompany?.companyName || "logistics company"
        }!`
      );
      setShowPriceNegotiationModal(false);
      setRequestedPrice("");
      ...
      toast.error(
        error.response?.data?.message || "Failed to send price update request"
      );
    } finally {
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Please wait while we fetch the bid details...
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <p className="text-gray-500 mb-4">
            You don't have permission to manage bids for this shipment.
          </p>
          <button
            onClick={() => navigate("/user/my-shipments")}
            className="px-6 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all duration-300 font-medium"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-lg">
                    Review and manage bids for your shipment
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">
                    {currentShipment.shipmentTitle || "N/A"}
                  </h2>
                  <div className="flex items-center gap-2 text-gray-600">
                    <MapPin size={16} />
                    <span>
                      {currentShipment.pickupCity || "N/A"} →{" "}
                      {currentShipment.deliveryCity || "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
                    <Calendar size={16} />
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span>
                      Type:{" "}
                      {currentShipment.typeOfGoods ||
                        currentShipment.modeOfTransport ||
                        "N/A"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    ...
                    <span>
                      Budget:{" "}
                      {getCurrencySymbol(
                        currentShipment.budgetCurrency || "USD"
                      )}
                      {currentShipment.budget || "N/A"}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  {selectedBid.status === "pending" && (
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-300 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-2 text-sm"
                      >
                        <CheckCircle size={18} />
                        Accept Bid
                      </button>
            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    You can either accept this bid or request a price update
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-4 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-300 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                >
                  <CheckCircle size={18} />
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-300 font-medium shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {priceRequestLoading ? (
                    <>
