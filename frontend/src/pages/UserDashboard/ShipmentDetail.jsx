...
const ShipmentDetail = () => {
  ...
  const handleUpdateShipmentStatus = async (newStatus) => {
    if (window.confirm(`Are you sure you want to update shipment status to "${newStatus}"?`)) {
            ...
            <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-3">
                  <div className={`px-4 py-2 rounded-full border-2 flex items-center gap-2 ${getStatusColor(currentShipment.status)}`}>
                    {getStatusIcon(currentShipment.status)}
                    <span className="font-semibold capitalize">{currentShipment.status}</span>
                  </div>
                  {currentShipment.status === 'delivered' && currentShipment.awaitingUserConfirmation && (
                    <div className="px-4 py-2 bg-yellow-100 text-yellow-800 border-2 border-yellow-200 rounded-full flex items-center gap-2">
                      ...
                      <span className="font-semibold text-sm">Awaiting Confirmation</span>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{currentShipment.descriptionOfGoods || 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Type of Goods</h3>
                        <p className="text-gray-600">{currentShipment.typeOfGoods || 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{currentShipment.weight ? `${currentShipment.weight} kg` : 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{currentShipment.quantity || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          {currentShipment.length && currentShipment.width && currentShipment.height 
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Mode of Transport</h3>
                        <p className="text-gray-600">{currentShipment.modeOfTransport || 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Insurance Required</h3>
                        <p className="text-gray-600">{currentShipment.insuranceRequired || 'N/A'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Handling Instructions</h3>
                        <p className="text-gray-600">{currentShipment.handlingInstructions || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">
                            {currentShipment.pickupAddress}, {currentShipment.pickupCity}, {currentShipment.pickupCountry}
                          </p>
                        </div>
                      </div>
                      
                      <div className="flex items-start gap-3">
                        <CalendarIcon className="text-gray-400 mt-1" size={16} />
                        <div>
                          <p className="font-medium text-gray-900">Preferred Pickup Date</p>
                          <p className="text-gray-600 text-sm">
                            {currentShipment.preferredPickupDate 
                              ? new Date(currentShipment.preferredPickupDate).toLocaleDateString()
                              : 'N/A'
                            }
                          </p>
                        </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">{currentShipment.pickupContactPerson || 'N/A'}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">{currentShipment.pickupPhoneNumber || 'N/A'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Address</p>
                          <p className="text-gray-600 text-sm">
                            {currentShipment.deliveryAddress}, {currentShipment.deliveryCity}, {currentShipment.deliveryCountry}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        <CalendarIcon className="text-gray-400 mt-1" size={16} />
                        <div>
                          <p className="font-medium text-gray-900">Preferred Delivery Date</p>
                          <p className="text-gray-600 text-sm">
                            {currentShipment.preferredDeliveryDate 
                              ? new Date(currentShipment.preferredDeliveryDate).toLocaleDateString()
                              : 'N/A'
                            }
                          </p>
                        </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Contact Person</p>
                          <p className="text-gray-600 text-sm">{currentShipment.deliveryContactPerson || 'N/A'}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">Phone Number</p>
                          <p className="text-gray-600 text-sm">{currentShipment.deliveryPhoneNumber || 'N/A'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div key={index} className="group flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200 hover:bg-gray-100 hover:shadow-md transition-all duration-300">
                        ...
                        <div className="flex-shrink-0">
                          <button
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm rounded-lg hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center gap-2"
                          >
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className={`px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1 ${getStatusColor(currentShipment.status)}`}>
                    {getStatusIcon(currentShipment.status)}
