  ...
  useEffect(() => {
    const fetchDeliveredShipments = async () => {
      ...
      try {
        ...
        toast.error(
          `Failed to fetch delivered shipments: ${
    ...
    socket.on("shipment-delivered-by-logistics", (shipment) => {
      if (shipment.user._id === user._id) {
        toast.info(
          `🚚 Your shipment "${shipment.shipmentTitle}" has been delivered! Please confirm receipt.`
        );
  ...
  const confirmDelivery = async () => {
    ...
    try {
      const result = await dispatch(
        markShipmentAsDeliveredByUser(shipmentToConfirm._id)
      );
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Please wait while we fetch your delivered shipments...
          </p>
        </div>
      </div>
    );
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-indigo-100 text-lg">
                    Confirm receipt of your delivered shipments
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2 border border-white/20">
                  <span className="text-white font-semibold text-lg">
                    {deliveredShipments?.length || 0} delivered
                  </span>
                </div>
                <button
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="text-center p-4 bg-blue-50 rounded-xl">
                  <div className="text-2xl font-bold text-pink-600 mb-1">
                    {
                      deliveredShipments.filter((s) => s.deliveredByLogistics)
                        .length
                    }
                  </div>
                  <div className="text-sm text-gray-600">
                  ...
                  <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {shipment.deliveredByLogistics && (
                        <div className="p-4 bg-blue-50 rounded-xl border border-indigo-200">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-blue-700">
                              Your shipment has been delivered by the logistics
                              company. Please confirm receipt to complete the
                              delivery process and unlock rating options.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="text-center">
                        ...
                        <div className="text-gray-600">
                          Your shipment is waiting for confirmation
                        </div>
                      </div>

                      <button
                        onClick={() => handleMarkAsDelivered(shipment)}
                        className="w-full px-6 py-4 bg-blue-500 text-white rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center gap-3"
                      >
                        <CheckCircle size={20} />
                        Confirm Delivery
                      </button>
            ...
            <div className="p-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  This will confirm that you have received the shipment "
                  {shipmentToConfirm?.shipmentTitle}" and complete the delivery
                  process.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-300">
                        After confirming, you can rate the delivery service and
                        provide feedback.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-blue-500 text-white rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                >
                  <CheckCircle size={16} />
                  Confirm Delivery
                </button>
