...
import { Mail, Phone, MapPin, Send, CheckCircle, AlertCircle, MessageSquare, HeadphonesIcon, Truck, Clock, Shield, Star } from 'lucide-react';
...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-1">da9783790@gmail.com</p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-1">+2347042168616</p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-1">123 Logistics Drive, Suite 400</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Transport City, TX 75001</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
            ...
            <AnimatePresence>
              ...
              {submitStatus === 'error' && (
                ...
                >
                  ...
                  <p className="text-red-800 dark:text-red-200 font-medium">Failed to send message. Please try again later.</p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 ${
                      errors.name ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                    }`}
                  />
                ...
                >
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 ${
                      errors.email ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                    }`}
                  />
              ...
              >
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-700 ${
                    errors.subject ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                  }`}
                />
              ...
              >
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 border rounded-xl shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 resize-none bg-white dark:bg-gray-700 ${
                    errors.message ? 'border-red-500 focus:ring-red-400' : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500'
                  }`}
                />
