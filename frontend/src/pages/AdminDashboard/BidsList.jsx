      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Please wait while we fetch all bids...
          </p>
        </div>
      </div>
    );
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100 text-base">
                      Monitor and manage all platform bids
                    </p>
                  </div>
                </div>
                      ...
                      {bid.shipment && (
                        <div className="bg-gray-50 rounded-lg p-4 mb-4">
                          ...
                          <p className="text-sm text-gray-700 mb-1">
                            {bid.shipment.shipmentTitle || "Untitled Shipment"}
                          </p>
                            ...
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${
                                bid.shipment.status === "open"
                                  ...
                                  : bid.shipment.status === "accepted"
                                  ? "bg-green-100 text-green-800"
                                  : bid.shipment.status === "completed"
                        ...
                        {bid.status === "pending" && (
                          <>
                            <button
                              ...
                              className="flex-1 bg-blue-500 text-white py-3 px-4 rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                            >
                              <CheckCircle size={16} />
                              Accept
                            </button>
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  ...
                  {Math.min(startIndex + itemsPerPage, filteredBids.length)} of{" "}
