...
const AdminDashboardHome = () => {
  ...
  console.log(
    "AdminDashboardHome - Logistics Pending (from adminSlice):",
    logisticsPending
  );
  console.log(
    "AdminDashboardHome - Logistics Verified (from adminSlice):",
    logisticsVerified
  );
  ...
  console.log(
    "AdminDashboardHome - Total Users (from adminSlice):",
    totalUsers
  );
  console.log(
    "AdminDashboardHome - Normal Users Count (from adminSlice):",
    normalUsersCount
  );
  ...
  useEffect(() => {
    ...
    if (!didFetch.current && users.length === 0 && !analytics) {
      fetchAndUpdate();
      setLastUpdated(new Date());
      didFetch.current = true;
    }
  }, [dispatch, users.length, analytics]);
  ...
  const modules = [
    {
      ...
      description: "Approved logistics companies.",
      icon: <Truck size={24} />,
      color: "from-blue-500 to-indigo-600",
      path: "/admin/logistics-list",
      count: analytics?.logistics?.verified || 0,
    },
    {
      name: "Pending Logistics",
      description:
        "Browse and manage pending logistics companies verifications.",
      icon: <ClipboardCheck size={24} />,
      color: "from-orange-500 to-red-600",
      path: "/admin/verify-logistics",
      count: analytics?.logistics?.pending || 0,
    },
    {
      name: "Total Users",
    ...
    },
    {
      ...
      description:
        "Manage and track all system reports from users and logistics.",
