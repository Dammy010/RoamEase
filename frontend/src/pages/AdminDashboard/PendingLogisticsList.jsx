...
import { fetchDashboardData, verifyLogistics, deleteUser, suspendUser } from "../../redux/slices/adminSlice";
...
import { 
  ...
  Building2, Eye, AlertCircle, CheckCircle, Clock as ClockIcon, RefreshCw,
  Download, Plus, Settings, ArrowLeft, ArrowRight, ChevronDown,
  Award, Star, Globe, FileText, Users, TrendingUp, Activity,
  CheckCircle2, XCircle, AlertTriangle, UserPlus, UserMinus
} from 'lucide-react';

const PendingLogisticsList = () => {
  const dispatch = useDispatch();
  const { logisticsPending, loading, error } = useSelector((state) => state.admin);
  ...
  const filteredCompanies = logisticsPending.filter(company => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-300 font-medium"
          >
            Try Again
          </button>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent appearance-none bg-white"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-xl border border-orange-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-orange-600">{logisticsPending.length}</div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-blue-600">{logisticsPending.filter(c => c.isActive !== false).length}</div>
                ...
                <div className="bg-gradient-to-r from-red-50 to-pink-50 p-4 rounded-xl border border-red-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-red-600">{logisticsPending.filter(c => c.isActive === false).length}</div>
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-xl border border-yellow-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-yellow-600">Verification</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {filteredCompanies.length === 0 ? (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-bold text-gray-800 mb-3">
                  {searchTerm || filterStatus !== 'all' ? 'No Matching Applications' : 'No Pending Applications'}
                </h3>
                ...
                {(searchTerm || filterStatus !== 'all') && (
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                    Clear Filters
                  </button>
                )}
                    ...
                    <tr key={company._id} className="hover:bg-gray-50 transition-colors duration-200">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            onClick={() => handleVerification(company._id, 'verify')}
                          ...
                          >
                            {company.isActive === false ? <UserPlus size={16} /> : <UserMinus size={16} />}
                          </button>
                          <button
            ...
            <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <div className="text-sm text-gray-600">
                  Showing {startIndex + 1} to {Math.min(startIndex + itemsPerPage, filteredCompanies.length)} of {filteredCompanies.length} applications
                </div>
