...
const VerifiedLogisticsList = () => {
  ...
  const filteredCompanies = logisticsVerified
    .filter((company) => {
      const matchesSearch =
      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">
            Loading Verified Logistics
          </h3>
          <p className="text-gray-500">
            Please wait while we fetch verified logistics companies...
          </p>
        </div>
      </div>
    );
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-green-100 text-base">
                      Manage approved logistics partners
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-white">
                    {logisticsVerified.length}
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-blue-600">
                        {
                          logisticsVerified.filter((c) => c.isActive !== false)
                            .length
                        }
                      </div>
