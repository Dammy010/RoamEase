            ...
            <div className="bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 p-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-white mb-2">Verified Logistics Companies</h1>
                    <p className="text-green-100 text-lg">Manage approved logistics partners</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-4xl font-bold text-white">{logisticsVerified.length}</div>
