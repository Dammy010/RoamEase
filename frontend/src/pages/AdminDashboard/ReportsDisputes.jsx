    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-2">Error Loading Disputes</h2>
      ...
      <div className="px-6 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div
              key={key}
              className={`bg-white dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700/50 p-6 cursor-pointer transition-all duration-200 hover:shadow-xl ${
      ...
      <div className="px-6 py-4 bg-white dark:bg-gray-800/50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700/50">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <button
            ...
            className="px-4 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm flex items-center space-x-2"
          >
      ...
      <div className="p-6">
        {filteredDisputes.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">No Disputes Found</h3>
            <p className="text-gray-500">
          ...
          <div className="space-y-4">
            {paginatedDisputes.map((dispute) => (
              <div
                key={dispute._id}
                className="bg-white dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700/50 overflow-hidden hover:shadow-xl transition-all duration-200"
              >
                {/* Dispute Header */}
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                      <div>
                      <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Reporter Details</h4>
                      ...
                      <div>
                      <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Against</h4>
                      <div className="space-y-2">
                        <p className="text-sm text-gray-600">
                    ...
                    <div className="mb-4">
                    <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Shipment Details</h4>
                  ...
                  {expandedDisputes.has(dispute._id) && (
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Admin Notes</h4>
                        ...
                        <div>
                          <h4 className="font-medium text-gray-800 dark:text-gray-200 mb-2">Resolution</h4>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Resolve Dispute</h3>
                <button
            ...
            <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
              <button
                onClick={() => setShowResolveModal(false)}
                className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-200 transition"
              >
                Cancel
              </button>
              <button
