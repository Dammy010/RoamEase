      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Please wait while we fetch all shipments...
          </p>
        </div>
      </div>
    );
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100 mt-1">
                      Monitor and manage all platform shipments
                    </p>
                  </div>
                </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div className="bg-blue-50 p-4 rounded-xl border border-emerald-200">
                  <div className="flex items-center gap-3">
                ...
                <div className="bg-blue-50 p-4 rounded-xl border border-indigo-200">
                  <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {shipment.pickupAddress || "Not specified"}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {shipment.deliveryAddress || "Not specified"}
                            </p>
                          </div>
                        </div>
                      </div>
