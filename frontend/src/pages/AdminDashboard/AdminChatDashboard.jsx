...
const AdminChatDashboard = () => {
  ...
  const { allConversations, currentAdminChatMessages, loading, error } =
  ...
  // Filter messages
  const filteredMessages = currentAdminChatMessages.filter(
    (message) =>
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        } w-full lg:w-96 bg-white dark:bg-gray-800/80 backdrop-blur-sm border-r border-gray-200 dark:border-gray-700/50 flex-shrink-0`}
      >
        {/* Header */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-700/50">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-lg font-bold bg-blue-600 bg-clip-text text-transparent">
                Chat Management
              </h1>
                ...
                <div
                  ...
                  className={`p-4 rounded-xl cursor-pointer transition-all duration-200 border ${
                    conversationId === conversation._id
                      ...
                      : "bg-white dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800/80 border-gray-200 dark:border-gray-700/50 hover:shadow-sm"
                  }`}
                  ...
                  <div className="space-y-2">
                    {conversation.participants.map((participant, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-6 h-6 rounded-full flex items-center justify-center ${info.bgColor}`}
                          >
                            <IconComponent
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {selectedConversation.participants.map((participant, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`flex items-center space-x-2 px-3 py-1 rounded-full ${info.bgColor}`}
                  >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <div
                          className={`w-12 h-12 rounded-full flex items-center justify-center ${participantInfo.bgColor} flex-shrink-0`}
                        >
                          <IconComponent
                            className={`w-6 h-6 ${participantInfo.color}`}
                          />
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center space-x-2">
                              ...
                              <span
                                className={`text-xs px-2 py-1 rounded-full ${participantInfo.bgColor} ${participantInfo.color}`}
                              >
