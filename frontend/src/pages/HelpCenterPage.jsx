  ...
  return (
    <div className="min-h-screen py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-gray-900 text-center mb-6">Help Center</h1>
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Managing Shipments</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Account & Billing</h2>
          ...
          <section className="text-center mt-12">
            ...
            <a href="/contact" className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300">
              Contact Support
            </a>
          </section>
        </div>
