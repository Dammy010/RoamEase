  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 className="text-4xl font-extrabold text-gray-900 text-center mb-8">Privacy Policy</h1>
        <p className="text-lg text-gray-600 text-center mb-12">
          Your privacy is important to us. This Privacy Policy explains how RoamEase collects, uses, and protects your information.
        </p>
        ...
        <div className="prose max-w-none text-gray-700">
          ...
          <ul>
            <li><strong>Personal Information:</strong> Name, email address, phone number, physical address, payment information, and government identification (for logistics providers).</li>
            <li><strong>Usage Data:</strong> Information about how you access and use the platform, such as your IP address, browser type, pages viewed, and time spent on our site.</li>
          ...
          <ul>
            ...
            <li>The right to rectify any incomplete or inaccurate information.</li>
          ...
          <h2>7. Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, please contact us at akindare2025@gmail.com.</p>
        </div>
      </div>
    </div>
  );
