  ...
  useEffect(() => {
    const fetchRatings = async () => {
      ...
      if (user.role !== "logistics") {
        toast.error(
          "You must be logged in as a logistics company to view ratings"
        );
        setLoading(false);
        return;
      }
      try {
        ...
        if (error.response?.status === 401) {
          ...
          toast.error(
            "Access denied. You must be logged in as a logistics company to view ratings."
          );
  ...
  const filteredAndSortedRatings = ratings
    ...
    .sort((a, b) => {
      switch (sortBy) {
        case "newest":
          return (
            new Date(b.ratedAt || b.updatedAt) -
            new Date(a.ratedAt || a.updatedAt)
          );
        case "oldest":
          return (
            new Date(a.ratedAt || a.updatedAt) -
      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Please wait while we fetch your ratings...
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-blue-50 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700">
            ...
            <div className="bg-blue-50 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-700">
              <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-50 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border border-yellow-200 dark:border-yellow-700">
              <div className="flex items-center gap-3">
            ...
            <div className="bg-blue-50 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 border border-purple-200 dark:border-purple-700">
              <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span>
                              {new Date(
                                rating.ratedAt || rating.updatedAt
                              ).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <p className="text-gray-700 dark:text-gray-300 italic">
                          ...
                          {rating.feedback.length > 150
                            ? `${rating.feedback.substring(0, 150)}...`
                            : rating.feedback}
                          "
                        </p>
                      </div>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-sm text-gray-600 dark:text-gray-400">
                                {rating.pickupCity}, {rating.pickupCountry} →{" "}
                                {rating.deliveryCity}, {rating.deliveryCountry}
                              </span>
                            </div>
                            <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-sm text-gray-600 dark:text-gray-400">
                                {formatCurrency(
                                  rating.budget || rating.estimatedCost || 0,
                                  rating.currency || "USD"
                                )}
                              </span>
                            </div>
