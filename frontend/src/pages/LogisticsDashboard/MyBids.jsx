        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Loading Your Bids</h3>
              <p className="text-gray-600">Fetching your bid history...</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-3">Error Loading Bids</h3>
        ...
        {myBids.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-3">No Bids Yet</h3>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-xl">
                          ...
                          <div>
                            ...
                            <div className="text-sm font-semibold text-gray-800">${bid.price.toFixed(2)}</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-xl">
                          ...
                          <div>
                            ...
                            <div className="text-sm font-semibold text-gray-800">{bid.eta}</div>
                          </div>
                        </div>
                      ...
                      <div className="mb-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl border border-indigo-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div className="bg-white p-4 rounded-xl border border-indigo-100">
                            ...
                            <div className="font-semibold text-gray-800 text-lg">${bid.price.toFixed(2)}</div>
                          </div>
                          <div className="bg-white p-4 rounded-xl border border-indigo-100">
                            <div className="text-sm text-gray-600 mb-1">Estimated Time</div>
                            <div className="font-semibold text-gray-800">{bid.eta}</div>
                          </div>
                          <div className="bg-white p-4 rounded-xl border border-indigo-100">
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <div className="font-semibold text-gray-800">{bid.shipment?.shipmentTitle || 'N/A'}</div>
                                </div>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                                ...
                                <div>
                                  ...
                                  <div className="font-semibold text-gray-800">{bid.shipment?.typeOfGoods || 'N/A'}</div>
                                </div>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                              ...
                              <div className="mt-4 p-3 bg-gray-50 rounded-xl">
                                ...
                                <div className="text-sm text-gray-800">{bid.shipment?.descriptionOfGoods || 'N/A'}</div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <div className="font-semibold text-gray-800">{bid.shipment?.user?.country || 'N/A'}</div>
                                </div>
                              </div>
                              {bid.shipment?.user?.email && (
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <div className="font-semibold text-gray-800">{bid.shipment.user.email}</div>
                                  </div>
                                </div>
                              )}
                            </div>
