          ...
          <div className="space-y-6">
            {filteredAndSortedHistory.map((shipment) => {
              ...
              return (
                <div
                  key={shipment._id}
                  className="group relative bg-white dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-600 hover:shadow-2xl hover:border-indigo-200 dark:hover:border-indigo-400 transition-all duration-300"
                >
                  {/* Shipment Header */}
                  <div className="p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4 mb-4">
                          <div className="w-16 h-16 bg-blue-500 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg group-hover:scale-105 transition-transform duration-300">
                            📦
                          </div>
                          <div className="flex-1">
                          ...
                          <div>
                            ...
                            <div className="space-y-3">
                              ...
                              <div>
                                ...
                                <p className="text-gray-600">
                                  {shipment.bid.eta || "Not specified"}
                                </p>
                              </div>
