...
import { 
  ...
  Truck, Package, Globe, Lock, Clock, Mail, Phone,
  MapPin, Award, TrendingUp, BookOpen, ExternalLink
} from 'lucide-react';
...
const PricingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Work together seamlessly with your team and logistics partners.'
    },
    {
      icon: Award,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We accept all major credit cards (Visa, MasterCard, American Express), bank transfers, and digital wallets. All payments are processed securely."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely! We offer significant discounts when you pay annually: 36% off Basic, 33% off Premium, and 33% off Enterprise plans."
    },
    {
      question: "What happens if I exceed my plan limits?",
      answer: "We'll notify you when you're approaching your limits. You can upgrade your plan or purchase additional shipments as needed."
    },
    {
      question: "Can I cancel anytime?",
      answer: "Yes, you can cancel your subscription at any time. No cancellation fees or long-term contracts. You'll retain access until the end of your billing period."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Choose the plan that best fits your logistics needs. All plans include essential features to streamline your operations.
          </motion.p>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Our comprehensive platform provides all the tools and features you need to manage and grow your logistics business effectively.
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of companies already using our platform to streamline their logistics operations.
            </p>
