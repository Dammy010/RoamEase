...
const ChatList = () => {
  ...
  return (
    <div className="w-64 border-r h-full bg-blue-50 flex-shrink-0 flex flex-col">
      {/* Fixed Header */}
      <div className="flex-shrink-0">
        <h2 className="text-lg font-bold p-4 border-b bg-blue-600 bg-clip-text text-transparent">
          Chats
        </h2>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    {/* Avatar */}
                    <div className="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                      {(() => {
                        const participant =
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate">
                        {otherParticipants.length > 0 &&
                        otherParticipants[0]?.role === "logistics"
                          ? "Logistics Partner"
                          : "User"}
                      </p>
                    </div>
                  ...
                  {displayUnreadCount > 0 && (
                    <span className="absolute top-2 right-2 bg-blue-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg animate-pulse min-w-[20px] h-5 flex items-center justify-center">
