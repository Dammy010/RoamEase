...
const Sidebar = ({ role }) => {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col w-48 h-screen bg-gray-900 dark:from-gray-800 dark:to-gray-900 text-white p-4 shadow-lg fixed top-0 left-0 z-30">
      ...
      <aside
        className={`fixed md:hidden top-0 left-0 h-screen w-64 bg-gray-900 dark:from-gray-800 dark:to-gray-900 text-white p-6 shadow-lg transform transition-transform duration-300 z-40 pt-16
